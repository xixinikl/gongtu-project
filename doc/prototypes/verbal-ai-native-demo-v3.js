(function () {
    ...
    function boot() {
        ...
        function renderHome() {
            learningZone.innerHTML = `<div class="big-card reasoning-home-v3"><div class="reasoning-kicker-v3">${icon.graph}<span>图形推理·学习入口</span></div><div class="reasoning-head-v3"><h2>先识别规律，再建立空间</h2><p>平面图推用导图建立规律索引；立体图推进入独立学习中心，按四段路径继续上次学习。</p></div><div class="reasoning-branches-v3"><section class="reasoning-branch-v3" data-mark="平"><h3>平面规律</h3><p>位置、样式、属性、数量四类规律，配合错题节点回看。</p><div class="reasoning-path-v3"><a class="reasoning-step-v3" href="/mindmap.html"><i>1</i><span>规律思维导图</span><small>进入</small></a><a class="reasoning-step-v3" href="/mindmap.html?tab=review"><i>2</i><span>错题归类与间隔复习</span><small>继续</small></a></div><a class="reasoning-branch-action-v3" href="/mindmap.html">打开平面图推</a></section><section class="reasoning-branch-v3" data-mark="立"><h3>立体空间</h3><p>基础截面、三视图、自由切面、组合体切割组成四段主链。</p><div class="reasoning-path-v3"><a class="reasoning-step-v3" href="/spatial-learning.html"><i>1</i><span>进入立体图推学习中心</span><small>继续学习</small></a><a class="reasoning-step-v3" href="/three-view-training.html"><i>2</i><span>三视图专项</span><small>直接练习</small></a></div><a class="reasoning-branch-action-v3" href="/spatial-learning.html">打开立体图推</a></section></div></div>`;
            renderRight('图推总览');
        }
        ...
        nav.addEventListener('click', event => {
            ...
            if (view === 'spatial') return location.href = '/spatial-learning.html';
